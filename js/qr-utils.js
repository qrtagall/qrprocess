...
const ICON_MAP = {
    ...
    Gdocs_Link: `<svg width="16" height="16" viewBox="0 0 24 24" fill="#4285F4"><path d="M6 2h9l5 5v15a1 1 0 0 1-1 1H6a1 1 0 0 1-1-1V3c0-.6.4-1 1-1zm8 7h5l-5-5v5z"/></svg>`,
    Gforms_Link: `<svg width="16" height="16" viewBox="0 0 24 24" fill="#673AB7"><path d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12V8l-4-6zM8 13h8v2H8v-2zm8 4H8v2h8v-2zm-2-8V3.5L18.5 9H14z"/></svg>`,
